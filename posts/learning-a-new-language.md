...
- If you can find a public radio or news service in your TL, put it on for a while everyday in the background. For example, I'm generally someone who doesn't keep up with global affairs and news, but every now and then I put on the [German public-broadcasting radio station](https://www.deutschlandfunk.de/programm) for 20 minutes. This way I get some immersion in my TL while also somewhat keeping up with world affairs.
...
Go ahead and [download Anki](https://apps.ankiweb.net/) onto your phone, laptop, or tablet. I personally use it on my laptop because there are far fewer distractions, and I can use keyboard shortcuts to breeze through cards faster. (Note that the iPhone app costs $25, but the other apps are free (Android/Windows/Linux/MacOS). They also have a free web based version.)

Once you have it installed, go ahead and download your first deck. A deck is a premade collection of flashcards that someone has prepared for you already. (You can also make your own decks, but this is beyond the scope of this post.) Click on Decks (plus icon on android) -> Get shared decks. This will take you to Anki's website for shared decks. Look for the language you're trying to learn, and find a deck for the 5000 most frequent words in your TL. 5000 words is a good number for your first year of learning, and should let you understand 95% of the words you encounter in your TL. For example, this is the kind of deck you should look for in [Spanish](https://ankiweb.net/shared/info/241428882).
...
![Anki card example](/assets/Pasted%20image%2020260112160228.png)
...
1. Look at the word (at first only the front of the card is shown to you). Try to remember the definition of the word. Don't spend more than 5-8 seconds trying to recall the definition.
    
2. Reveal the back of the card. If this is the first time seeing this word, look closely at the word and its definition, listen to the audio pronunciation and say it out loud a few times. Try to reproduce the sounds as accurately as you can. Don't spend too long here—you'll see the word again soon. Click the **Again** button and move on to the next card.
    
3. If you were able to recall the word immediately (within 1 second), click on **Easy**. If it took you 2-3 seconds, click **Good**.
    
4. If you were able to recall the word eventually, but it took a lot of hard thinking to get there, click on **Hard**. Now look at the definition and say the sample phrase out loud to yourself.
    
5. If you couldn't recall the word at all, go through the entirety of the card again like in step 2, and click on **Again**. 

![Anki recall buttons](/assets/Pasted%20image%2020260112162814.png)

It's important here to be very honest with yourself. If you lie to the software, it's going to assume you know the word better than you do, and you will never end up learning it fully. Be _harsh and truthful_ with the options.

#### Help with setting up Anki

You can read [this post](https://refold.la/roadmap/stage-1/a/anki-setup/#Preferences) for more detailed instructions on setting up Anki. I'm aware that Anki isn't the most user-friendly software out there, and the number of options and settings can seem super intimidating when you're first getting started. This is okay, here's a [short Youtube video](https://www.youtube.com/watch?v=6BJgxHC3Yuc) that should help you get comfortable with the software.
...
* **Pick up a grammar textbook:** Look for one that's well-recommended. There are broadly two kinds: **reference books**, which give you cold hard facts about rules and exceptions, and **coursebooks**, which are intended to be more comprehensive and spoon-feed information slowly. I find the former easier and quicker to go through, as I find content designed to "engage" you can be terribly boring.
* **Find grammar videos on YouTube:** Look for videos that tackle one topic at a time. You can find a list of topics for your level from a textbook and then search for explanations and practice videos for that specific topic. 
